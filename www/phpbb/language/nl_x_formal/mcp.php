...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> 'Als je hierover een rapport wil toevoegen, vul dan het volgende formulier in. Gebruik alleen platte tekst; HTML, BBCode, etc. zijn niet toegestaan.',
	...
	'APPROVE_POST_CONFIRM'	=> 'Weet je zeker dat je dit bericht wil goedkeuren?',
	...
	'APPROVE_TOPIC_CONFIRM'	=> 'Weet je zeker dat je dit onderwerp wil goedkeuren?',
	'APPROVE_TOPICS'		=> 'Onderwerpen goedkeuren',
	'APPROVE_TOPICS_CONFIRM'=> 'Weet je zeker dat je de geselecteerde onderwerpen wil goedkeuren?',

	'CANNOT_MOVE_SAME_FORUM'=> 'Je kunt een onderwerp niet verplaatsen naar het forum waar het al in staat.',
	'CANNOT_WARN_ANONYMOUS'	=> 'Je kunt een niet geregistreerde gastgebruiker niet waarschuwen.',
	...
	'CLOSE_PM_REPORT_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde pb-melding wil sluiten?',
	'CLOSE_PM_REPORTS'		=> 'Sluit pb-meldingen',
	'CLOSE_PM_REPORTS_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde pb-meldingen wil sluiten?',
	'CLOSE_REPORT'			=> 'Sluit melding',
	'CLOSE_REPORT_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde melding wil sluiten?',
	'CLOSE_REPORTS'			=> 'Sluit meldingen',
	'CLOSE_REPORTS_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde meldingen wil sluiten?',

	'DELETE_PM_REPORT'			=> 'Verwijder PB-melding',
	'DELETE_PM_REPORT_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde pb-melding wil verwijderen?',
	'DELETE_PM_REPORTS'			=> 'Verwijder PB-meldingen',
	'DELETE_PM_REPORTS_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde pb-meldingen wil verwijderen?',
	'DELETE_POSTS'				=> 'Verwijder berichten',
	'DELETE_REPORT'				=> 'Verwijder melding',
	'DELETE_REPORT_CONFIRM'		=> 'Weet je zeker dat je de geselecteerde melding wil verwijderen?',
	'DELETE_REPORTS'			=> 'Verwijder meldingen',
	'DELETE_REPORTS_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde meldingen wil verwijderen?',
	'DELETE_SHADOW_TOPIC'		=> 'Verwijder schaduwonderwerp',
	'DELETE_TOPICS'				=> 'Verwijder geselecteerde onderwerpen',
	'DISAPPROVE'				=> 'Afkeuren',
	'DISAPPROVE_REASON'			=> 'Reden voor afkeuring',
	'DISAPPROVE_POST'			=> 'Afkeuren bericht',
	'DISAPPROVE_POST_CONFIRM'	=> 'Weet je zeker dat je dit bericht wil afkeuren?',
	'DISAPPROVE_POSTS'			=> 'Afkeuren berichten',
	'DISAPPROVE_POSTS_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde berichten wil afkeuren?',
	'DISPLAY_LOG'				=> 'Toon regels van vorige',
	...
	'FORK_TOPIC_CONFIRM'	=> 'Weet je zeker dat je dit onderwerp wil kopiëren?',
	'FORK_TOPICS'			=> 'Kopiëer geselecteerde onderwerpen',
	'FORK_TOPICS_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde onderwerpen wil kopiëren?',
	...
	'IP_INFO'				=> 'Informatie over IP-adres',
	...
	'LOCK_POST_POST_CONFIRM'	=> 'Weet je zeker dat je wil voorkomen dat dit bericht gewijzigd kan worden?',
	'LOCK_POST_POSTS'			=> 'Sluit geselecteerde berichten',
	'LOCK_POST_POSTS_CONFIRM'	=> 'Weet je zeker dat je wil voorkomen dat deze berichten gewijzigd kunnen worden?',
	'LOCK_TOPIC_CONFIRM'		=> 'Weet je zeker dat je dit onderwerp wil sluiten?',
	'LOCK_TOPICS'				=> 'Sluit geselecteerde onderwerpen',
	'LOCK_TOPICS_CONFIRM'		=> 'Weet je zeker dat je alle geselecteerde onderwerpen wil sluiten?',
	...
	'MCP_MAKE_ANNOUNCEMENT_CONFIRM'	=> 'Weet je zeker dat je dit onderwerp wil veranderen naar een “Aankondiging”?',
	'MCP_MAKE_ANNOUNCEMENTS'		=> 'Wijzig naar “Aankondigingen”',
	'MCP_MAKE_ANNOUNCEMENTS_CONFIRM'=> 'Weet je zeker dat je de geselecteerde onderwerpen wil veranderen naar “Aankondigingen”?',
	'MCP_MAKE_GLOBAL'				=> 'Wijzig naar “Algemene aankondiging”',
	'MCP_MAKE_GLOBAL_CONFIRM'		=> 'Weet je zeker dat je dit onderwerp wil veranderen naar een “Algemene aankondiging”?',
	'MCP_MAKE_GLOBALS'				=> 'Wijzig naar “Algemene aankondigingen”',
	'MCP_MAKE_GLOBALS_CONFIRM'		=> 'Weet je zeker dat je de geselecteerde onderwerpen wil veranderen naar “Algemene aankondigingen”?',
	'MCP_MAKE_STICKY'				=> 'Wijzig naar “Sticky”',
	'MCP_MAKE_STICKY_CONFIRM'		=> 'Weet je zeker dat je dit onderwerp wil veranderen naar een “Sticky”?',
	'MCP_MAKE_STICKIES'				=> 'Wijzig naar “Stickies”',
	'MCP_MAKE_STICKIES_CONFIRM'		=> 'Weet je zeker dat je de geselecteerde onderwerpen wil veranderen naar “Stickies”?',
	'MCP_MAKE_NORMAL'				=> 'Wijzig naar “Standaard onderwerp”',
	'MCP_MAKE_NORMAL_CONFIRM'		=> 'Weet je zeker dat je dit onderwerp wil veranderen naar een “Standaard onderwerp”?',
	'MCP_MAKE_NORMALS'				=> 'Wijzig naar “Standaard onderwerpen”',
	'MCP_MAKE_NORMALS_CONFIRM'		=> 'Weet je zeker dat je de geselecteerde onderwerpen wil veranderen naar “Standaard onderwerpen”?',
	...
	'MCP_QUEUE_DELETED_POSTS_EXPLAIN'		=> 'Dit is een lijst van alle tijdelijk verwijderde berichten. Je kunt vanuit dit scherm de berichten terugzetten of permanent verwijderen.',
	'MCP_QUEUE_DELETED_TOPICS'				=> 'Verwijderde onderwerpen',
	'MCP_QUEUE_DELETED_TOPICS_EXPLAIN'		=> 'Dit is een lijst van alle tijdelijk verwijderde onderwerpen. Je kunt vanuit dit scherm de onderwerpen terugzetten of permanent verwijderen.',
	...
	'MERGE_POSTS_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde berichten wil verplaatsen?',
	'MERGE_TOPIC_EXPLAIN'	=> 'Door het formulier hieronder te gebruiken kun je de geselecteerde berichten verplaatsen naar een ander onderwerp. De berichten zullen gesplitst worden van dit onderwerp en samengevoegd worden met het andere onderwerp. Deze berichten zullen niet opnieuw gesorteerd worden en het zal lijken alsof de gebruiker ze geplaatst heeft in het nieuwe onderwerp.<br />Vul de doel onderwerp ID in of klik op “Selecteer onderwerp” om naar één te zoeken.',
	'MERGE_TOPIC_ID'		=> 'Doel onderwerp identificatie nummer',
	'MERGE_TOPICS'			=> 'Onderwerpen samenvoegen',
	'MERGE_TOPICS_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde onderwerpen wil samenvoegen?',
	...
	'MOVE_TOPIC_CONFIRM'	=> 'Weet je zeker dat je het onderwerp naar een nieuw forum wil verplaatsen?',
	'MOVE_TOPICS'			=> 'Verplaats geselecteerde onderwerpen',
	'MOVE_TOPICS_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde onderwerpen naar een nieuw forum wil verplaatsen?',
	...
	'NO_REASON_DISAPPROVAL'			=> 'Geef een passende reden voor afkeuring.',
	...
	'PM_REPORT_DETAILS'			=> 'Privéberichtmeldingdetails',
	'POSTER'					=> 'Auteur',
	...
	'READ_USERNOTES'			=> 'Gebruikernotities',
	'READ_WARNINGS'				=> 'Gebruikerwaarschuwingen',
	'REPORTER'					=> 'Melder',
	'REPORTED'					=> 'Gemeld',
	...
	'RESTORE_POST_CONFIRM'		=> 'Weet je zeker dat je dit bericht wil terugzetten?',
	'RESTORE_POSTS'				=> 'Terugzetten berichten',
	'RESTORE_POSTS_CONFIRM'		=> 'Weet je zeker dat je de geselecteerde berichten wil terugzetten?',
	'RESTORE_TOPIC'				=> 'Terugzetten onderwerp',
	'RESTORE_TOPIC_CONFIRM'		=> 'Weet je zeker dat je dit onderwerp wil terugzetten?',
	'RESTORE_TOPICS'			=> 'Terugzetten onderwerpen',
	'RESTORE_TOPICS_CONFIRM'	=> 'Weet je zeker dat je de geselecteerde onderwerpen wil terugzetten?',
	...
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENT'	=> 'Selecteer het forum waarin je deze algemene aankondiging wil weergeven.',
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENTS'	=> 'Eén of meer van de geselecteerde onderwerpen zijn algemene aankondigingen. Selecteer het forum waarin je deze wil weergeven.',
	...
	'SPLIT_SUBJECT'						=> 'Titel nieuw onderwerp',
	'SPLIT_TOPIC_ALL'					=> 'Splits onderwerp vanaf geselecteerde berichten',
	'SPLIT_TOPIC_ALL_CONFIRM'			=> 'Weet je zeker dat je dit onderwerp wil splitsen?',
	'SPLIT_TOPIC_BEYOND'				=> 'Splits onderwerp vanaf geselecteerde bericht',
	'SPLIT_TOPIC_BEYOND_CONFIRM'		=> 'Weet je zeker dat je dit onderwerp wil splitsen vanaf het geselecteerde bericht?',
	'SPLIT_TOPIC_EXPLAIN'				=> 'Door het gebruik van het formulier hieronder kun je een onderwerp in tweeën splitsen, door de berichten individueel te selecteren of door te splitsen vanaf een geselecteerd bericht.',
	...
	'UNLOCK_POST_POST_CONFIRM'		=> 'Weet je zeker dat je het wijzigen van dit bericht wil toestaan?',
	'UNLOCK_POST_POSTS'				=> 'Geselecteerde berichten openen',
	'UNLOCK_POST_POSTS_CONFIRM'		=> 'Weet je zeker dat je het wijzigen van de geselecteerde berichten wil toestaan?',
	'UNLOCK_TOPIC'					=> 'Onderwerp openen',
	'UNLOCK_TOPIC_CONFIRM'			=> 'Weet je zeker dat je dit onderwerp wil openen?',
	'UNLOCK_TOPICS'					=> 'Geselecteerde onderwerpen openen',
	'UNLOCK_TOPICS_CONFIRM'			=> 'Weet je zeker dat je alle geselecteerde onderwerpen wil openen?',
	...
	'USER_FEEDBACK_ADDED'			=> 'Gebruikerfeedback succesvol toegevoegd.',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			...
			'OTHER'		=> 'Het gemelde bericht valt niet binnen een categorie, vul het volgende informatieveld in.',
		),
	),
));

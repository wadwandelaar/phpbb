...
$lang = array_merge($lang, array(
	...
	'DEACTIVATE_DELETE_EXPLAIN'	=> 'Kies of je gebruikers wil deactiveren of compleet wil verwijderen. Let op dat verwijderde gebruikers niet teruggehaald kunnen worden!',
	...
	'PRUNE_USERS_LIST_DELETE'		=> 'Met de geselecteerde criteria voor het opschonen van gebruikers, zullen de volgende accounts verwijderd worden. Je kunt individuele gebruikers van de opschoonlijst verwijderen door het vakje naast hun gebruikersnaam uit te zetten.',
	'PRUNE_USERS_LIST_DEACTIVATE'	=> 'Met de geselecteerde criteria voor het opschonen van gebruikers, zullen de volgende accounts gedeactiveerd worden. Je kunt individuele gebruikers van de deactivatielijst verwijderen door het vakje naast hun gebruikersnaam uit te zetten.',
...
// Forum Pruning
$lang = array_merge($lang, array(
	'ACP_PRUNE_FORUMS_EXPLAIN'	=> 'Dit zal elk onderwerp, waarin geen berichten zijn geplaatst of bekeken is in het aantal dagen dat je selecteert, opschonen. Als je geen cijfer invult zullen alle onderwerpen verwijderd worden. Standaard zal het geen onderwerpen verwijderen waarin nog open peilingen zijn en zal het geen stickies en mededelingen verwijderen.',
